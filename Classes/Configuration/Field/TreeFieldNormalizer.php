...
class TreeFieldNormalizer extends AbstractFieldConfigurationNormalizer
{
    ...
    public function normalize(FieldInterface|Tree $field, array $normalizedFieldConfiguration, array $config): array
    {
        $normalizedFieldConfiguration['type'] = FieldType::TREE;
